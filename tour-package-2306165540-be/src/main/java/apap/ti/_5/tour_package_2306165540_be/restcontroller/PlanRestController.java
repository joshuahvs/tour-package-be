...
public class PlanRestController {
    ...
    public ResponseEntity<BaseResponseDTO<PlanDetailResponseDTO>> getPlanDetail(@PathVariable UUID planId) {
        try {
            ...
            response.setStatus(HttpStatus.OK.value());
            response.setMessage("Successfully retrieved plan detail");
            response.setData(plan);
            response.setTimestamp(new Date());
            ...
            BaseResponseDTO<PlanDetailResponseDTO> response = new BaseResponseDTO<>();
            response.setStatus(HttpStatus.INTERNAL_SERVER_ERROR.value());
            response.setMessage("Failed to retrieve plan detail: " + e.getMessage());
            response.setData(null);
            response.setTimestamp(new Date());
